        ...
        <div class="row h-100">
            ...
            {{$product['color_dark']}} " style="background-color: #FAFAFA; ">
                <div class="pt-5 pb-md-3 pb-xs-5">
                    ...
                    <h1 class="text-center text-lg mt-3 h2"><b>{{ $product['name'] }}</b></h1>
                    ...
                    <div class="col-md-12 justify-content-center px-5 mt-5">
                        <div class=" d-flex align-items-center justify-content-left">
                            <span
                                class="h5 align-self-center d-inline-block color-black">Ideal para un {{ $product['suggest'] }}</span>
                            <img class="img-fluid w-5" src="{{ asset('/assets/images/backgrounds/cup.png') }}"
                                 alt="cañablanca-{{ $product['name'] }}">
                        </div>
                        <?php $count = 1; ?>
                        @foreach($product['preparation'] as $preparation)
                            <ul>
                                <li class="text-left"><span
                                        class="color-black bold mr-2">{{ $count++ }}.</span> {{ $preparation }}</li>
                            </ul>
                        @endforeach
                    </div>
            ...
            <div class="col-lg-6 col-sm-12 mt-lg-0  imagen-producto d-flex justify-content-center align-items-center">
                ...
                <div class="col-lg-12">
                    <img class="img-fluid product-img-content-detail img-round" src="{{ $product['main_img'] }}"
                         alt="cañablanca-{{ $product['name'] }}" loading="lazy">
                </div>
