        ...
        <div class="row h-100">
            ...
            {{$product['color_dark']}} " style="background-color: #FAFAFA; ">
                <div class="pt-5 pb-md-3 pb-xs-5">
                    <h5 class="texto-principal text-lg text-center text"><b>CAÑABLANCA</b></h5>
                    <h1 class="text-center text-lg mt-5"><b>{{ $product['name'] }}</b></h1>
                    <p class="mt-5 text-center px-5">{{ $product['description-short'] }}</p>
                    <div class="d-flex justify-content-center mt-5">
                        <img class="img-fluid" src="{{ asset('/assets/images/backgrounds/cup.png') }}" alt="{{ $product['name'] }}">
                        <span class="h4 align-self-center d-inline-block ">{{ $product['suggest'] }}</span>
