<div class="section nobg topmargin-lg nobottommargin">
    ...
    <div class="container mt-5 clearfix">
        <div class="col_half nobottommargin center">
            <img src="{{ asset('assets/images/products/azul_ancha.jpg') }}" alt="Image" class="img-fluid rounded">
        </div>
        <div class="col_half nobottommargin col_last">
            <div class="heading-block">
                <h2>Mosto Verde.</h2>
                <span>Se puede tomar puro para identificar su cuerpo, sabor y aroma a caña de azúcar.</span>
            </div>
            <p>
                <span class="text-primary">Ideal para un Chilcano</span> <br>
                1. En un vaso colocar cubos de hielo. <br>
                2. Agregar CAÑABLANCA Mosto verde sobre el hielo para despertar su sabor. <br>
                3. Llenar a tres cuartos del vaso con gaseosa de jengibre o Evervess. <br>
