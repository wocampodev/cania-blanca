            ...
            <div class="row footer-p">
                <div class="col-lg-3 pr-lg-5">
                    <a class="navbar-brand d-flex justify-content-center" href="{{ url('/') }}">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="CAÑABLANCA" title="Caña Blanca"
                             style="height:55px;"/>
                    </a>
                    ...
                    <div class="row text-left">
                        <div class="col-12 column ">
                            <ul class="footer-gd-16">
                                <li class="d-flex"><a href="{{ route('home') }}"><i
                                            class="fa fa-angle-right"
                                            aria-hidden="true"></i>Inicio</a></li>
                                <li class="d-flex"><a href="{{ route('about') }}"><i
                                            class="fa fa-angle-right"
                                            aria-hidden="true"></i>Conócenos </a></li>
                                <li class="d-flex"><a href="{{ route('products.all') }}"><i
                                            class="fa fa-angle-right"
                                            aria-hidden="true"></i>Nuestro Licor</a></li>
                                <li class="d-flex"><a href="{{ route('contact') }}"><i
                                            class="fa fa-angle-right"
                ...
                <div class="col-lg-3 col-sm-4 col-4 mt-lg-0 mt-4">
                    ...
                    <div class="row text-left">
                        <div class="col-12 column ">
                            <ul class="footer-gd-16">
                                <li class="d-flex"> <a href="{{ route('product.detail','macerado-damascos') }}"><i
                                            class="fa fa-angle-right text-uppercase"
                                            aria-hidden="true"></i>Macerado Damascos</a></li>
                                <li class="d-flex"><a href="{{ route('product.detail','hierba-luisa') }}"><i
                                            class="fa fa-angle-right text-uppercase"
                                            aria-hidden="true"></i>Hierba Luisa</a></li>
                                <li class="d-flex"><a  href="{{ route('product.detail','mosto-verde') }}"><i
                                            class="fa fa-angle-right text-uppercase"
                                            aria-hidden="true"></i>Mosto Verde</a></li>
                                <li class="d-flex"><a href="{{ route('product.detail','cogollito') }}"><i  class="fa fa-angle-right text-uppercase"
                                            aria-hidden="true"></i>Cogollito</a></li>
                                <li class="d-flex"><a
                                        href="{{ route('product.detail','manzanilla') }}"><i
                                            class="fa fa-angle-right text-uppercase"
                                            aria-hidden="true"></i>Manzanilla</a></li>
                                <li class="d-flex"><a
                                        href="{{ route('product.detail','uva-italia') }}"><i
                                            class="fa fa-angle-right text-uppercase"
                                            aria-hidden="true"></i>Uva Italia</a></li>
                                <li class="d-flex"><a
                                        href="{{ route('product.detail','macerado-arandanos') }}"><i
                                            class="fa fa-angle-right text-uppercase"
                    ...
                    <div class="row">
                        <div class="col-12 column">
                            <ul class="footer-gd-16 social d-flex justify-content-center">
                                <li><a href="javascript:void(0);"><span class="fa fa-facebook"
                                                                        aria-hidden="true"></span></a>
                                </li>
                                <li><a href="javascript:void(0);"><span class="fa fa-instagram"
                                                                        aria-hidden="true"></span></a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="d-flex below-section justify-content-center align-items-center pt-4 mt-5">
                <div class="columns text-lg-left">
                    <p class="copy-text">@ 2020 CAÑABLANCA. Todos los derechos reservados. Desarrollado por <a
                            href="https://www.codecix.com" target="_blank">
                            Codecix</a>
                    </p>
                </div>
            </div>
