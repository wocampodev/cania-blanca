        ...
        <div class="container">
            <div class="row footer-p">
                <div class="col-lg-4 pr-lg-5">
                    <a class="logo" href="javascript:void(0);"><i class="fa fa-cutlery" aria-hidden="true"></i> Foodies</a>
                    ...
                    <div class="row">
                        <div class="col-6 column">
                            <ul class="footer-gd-16">
                                ...
                                <li><a href="javascript:void(0);"><i class="fa fa-angle-right" aria-hidden="true"></i>About
                                        Us</a></li>
                                <li><a href="javascript:void(0);"><i class="fa fa-angle-right"
                                            aria-hidden="true"></i>Services</a></li>
                                <li><a href="javascript:void(0);"><i class="fa fa-angle-right" aria-hidden="true"></i>Blog
                                        Posts</a></li>
                                <li><a href="javascript:void(0);"><i class="fa fa-angle-right"
